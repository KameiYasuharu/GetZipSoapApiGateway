...
public class LoggingAspect {
	...
	// コントロール
	@Pointcut("execution(public * com.example.apigateway..*.*(..)) && within(@org.springframework.stereotype.Controller *) ")
	public void controllerPointcut() {
	}

	// サービス
	@Pointcut("execution(public * com.example.apigateway..*.*(..)) && within(@org.springframework.stereotype.Service *) ")
